...
from rrc_simulation.gym_wrapper.envs.cube_env_modified import ActionType, RandomInitializer, \
    CompletelyRandomInitializer, FixedInitializer
...
if __name__ == '__main__':
    ...
    with open('sac_base_parameters.yml', 'r') as f:
